...
;#############MY EDITS#########################################
(defvar doctor--kanpur)
(defvar doctor--hyderabad)
(defvar doctor--delhi)
(defvar doctor--mumbai)
;#############MY EDITS#########################################
...
(defun make-doctor-variables ()
  ...
  ;#############MY EDITS#########################################
  (set (make-local-variable 'doctor--kanpur)
      '((Hi there from Kanpur\.) 
      	(Oh\, Kanpur must be a nice place to live\.) 
      	(I once lived in Kanpur too\.) 
      	(Good\.) ) )

  (set (make-local-variable 'doctor--hyderabad)
      '((Hi there from Hyderabad\.) 
      	(Oh\, Hyderabad must be a nice place to live\.) 
      	(I once lived in Hyderabad too\.) 
      	(Good\.) ) )

  (set (make-local-variable 'doctor--delhi)
      '((Hi there from Delhi\.) 
      	(Oh\, Delhi must be a nice place to live\.) 
      	(I once lived in Delhi too\.) 
      	(Good\.) ) )

  (set (make-local-variable 'doctor--mumbai)
      '((Hi there from Mumbai\.) 
      	(Oh\, Mumbai must be a nice place to live\.) 
      	(I once lived in Mumbai too\.) 
      	(Good\.) ) )
  ;#############MY EDITS#########################################
...
;#############MY EDITS#########################################
(doctor-put-meaning kanpur 'kanpur)
(doctor-put-meaning hyderabad 'hyderabad)
(doctor-put-meaning delhi 'delhi)
(doctor-put-meaning mumbai 'mumbai)
;#############MY EDITS#########################################
...
;#############MY EDITS#########################################
(defun doctor-kanpur ()
  (doctor-type (doc$ doctor--kanpur))
  )

(defun doctor-hyderabad ()
  (doctor-type (doc$ doctor--hyderabad))
  )

(defun doctor-delhi ()
  (doctor-type (doc$ doctor--delhi))
  )

(defun doctor-mumbai ()
  (doctor-type (doc$ doctor--mumbai))
  )
;#############MY EDITS#########################################
